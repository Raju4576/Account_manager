...
const UpdateName = ({ onCancel, id }) => {
    ...
    const update = async () => {
        ...
        if (validate()) {
            ...
            //   
            const response = await fetch(`${ipaddress}/update/${id}`, {
        ...
        <View style={styles.maincont}>
            <View style={styles.dialog}>
                <View style={styles.text}>
                    <Text style={{ color: 'white', fontWeight: 'bold', textAlign: 'center' }}>Update Name</Text>
                </View>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            {errors.pert && <Text style={styles.errorText}>{errors.pert}</Text>}
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: '2%' }}>
                        ...
                        <Pressable style={styles.btn2} onPress={update}>
